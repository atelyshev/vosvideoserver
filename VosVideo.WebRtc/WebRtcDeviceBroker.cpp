...
WebRtcDeviceBroker::WebRtcDeviceBroker(std::shared_ptr<vosvideo::communication::PubSubService> pubsubService, 
...
WebRtcDeviceBroker::~WebRtcDeviceBroker()
{
}

void WebRtcDeviceBroker::OnMessageReceived(const shared_ptr<ReceivedData> receivedMessage)
{	
...
void WebRtcDeviceBroker::DeleteAllPeerConnections()
{
...
void WebRtcDeviceBroker::DeletePeerConnection(const wstring& fromPeer)
{
...
int WebRtcDeviceBroker::CheckFinishingPeerConnections()
{
...
void WebRtcDeviceBroker::CreatePeerConnectionFactory()
{
